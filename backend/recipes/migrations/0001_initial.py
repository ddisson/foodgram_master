# Generated by Django 3.2.3 on 2023-11-07 17:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(default='#49B64E', max_length=7, unique=True, validators=[django.core.validators.RegexValidator('^#[a-fA-F0-9]{6}$', 'Enter a valid HEX color. (e.g., "#FF0033")')], verbose_name='Цвет(HEX)')),
            ],
            options={
                'verbose_name': 'Тег',
